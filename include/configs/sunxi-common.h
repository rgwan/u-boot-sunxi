...
#error "Can't use MMC slot 0 if the UART is directed there!"
#endif
...
#define CONFIG_ENV_OFFSET	0x500000 // located at 5MB
#define CONFIG_ENV_RANGE        0x300000 // 3MB env partition
